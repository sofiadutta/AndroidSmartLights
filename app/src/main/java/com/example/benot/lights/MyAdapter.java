...
//                Log.v("Prajit info", kasaInfo.getLights()[i][j]);
//            }
//        }
//        Log.v("Prajit info", "got out!");
...
//            Log.v("Prajit what did we get?", "'"+mDataset[position][1].substring(1)+"'");
            holder.mSwitch.setChecked(Integer.parseInt(mDataset[position][1].substring(1)) == 1);
        }
        else {
//            Log.v("Prajit what did we get in else?", mDataset[position][1]);
        ...
        holder.mSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                try {
                    ...
                    Log.v("Prajit debug", e.getMessage().toString());
                }
            }
        });
    }
